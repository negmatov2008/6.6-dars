...
function Earth() {
  const [planetImg, setPlanetImg] = useState(Api.data[2].images.planet);
  const [paragraph, setParagraph] = useState(Api.data[2].overview);
  const [index, setIndex] = useState(0);
  function handleClick(i) {
    setIndex(i);
    if (i == 0) {
      setPlanetImg(Api.data[2].images.planet);
      setParagraph(Api.data[2].overview);
    } else if (i == 1) {
      setPlanetImg(Api.data[2].images.internal);
      setParagraph(Api.data[2].structure);
    } else if (i == 2) {
      setPlanetImg(Api.data[2].images.geology);
      setParagraph(Api.data[2].geology);
    }
  }
    ...
    <div className="container">
      ...
      <div className="footer">
        <div className="box">
          ...
          <span>{Api.data[2].rotation}</span>
        </div>
        <div className="box">
          <span>REVOLUTION TIME</span>
          <span>{Api.data[2].revolution}</span>
        </div>
        <div className="box">
          <span>radius</span>
          <span>{Api.data[2].radius}</span>
        </div>
        <div className="box">
          <span>AVERAGE TEMP.</span>
          <span>{Api.data[2].temperature}</span>
        </div>
      </div>
    </div>
  );
