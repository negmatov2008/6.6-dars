...
function Neptune() {
  const [planetImg, setPlanetImg] = useState(Api.data[7].images.planet);
  const [paragraph, setParagraph] = useState(Api.data[7].overview);
  const [index, setIndex] = useState(0);
  function handleClick(i) {
    setIndex(i);
    if (i == 0) {
      setPlanetImg(Api.data[7].images.planet);
      setParagraph(Api.data[7].overview);
    } else if (i == 1) {
      setPlanetImg(Api.data[7].images.internal);
      setParagraph(Api.data[7].structure);
    } else if (i == 2) {
      setPlanetImg(Api.data[7].images.geology);
      setParagraph(Api.data[7].geology);
    }
  }
    ...
    <div className="container">
      ...
      <div className="footer">
        <div className="box">
          ...
          <span>{Api.data[7].rotation}</span>
        </div>
        <div className="box">
          <span>REVOLUTION TIME</span>
          <span>{Api.data[7].revolution}</span>
        </div>
        <div className="box">
          <span>radius</span>
          <span>{Api.data[7].radius}</span>
        </div>
        <div className="box">
          <span>AVERAGE TEMP.</span>
          <span>{Api.data[7].temperature}</span>
        </div>
      </div>
    </div>
  );
