...
function Urans() {
  const [planetImg, setPlanetImg] = useState(Api.data[6].images.planet);
  const [paragraph, setParagraph] = useState(Api.data[6].overview);
  const [index, setIndex] = useState(0);
  function handleClick(i) {
    setIndex(i);
    if (i == 0) {
      setPlanetImg(Api.data[6].images.planet);
      setParagraph(Api.data[6].overview);
    } else if (i == 1) {
      setPlanetImg(Api.data[6].images.internal);
      setParagraph(Api.data[6].structure);
    } else if (i == 2) {
      setPlanetImg(Api.data[6].images.geology);
      setParagraph(Api.data[6].geology);
    }
  }
    ...
    <div className="container">
      ...
      <div className="footer">
        <div className="box">
          ...
          <span>{Api.data[6].rotation}</span>
        </div>
        <div className="box">
          <span>REVOLUTION TIME</span>
          <span>{Api.data[6].revolution}</span>
        </div>
        <div className="box">
          <span>radius</span>
          <span>{Api.data[6].radius}</span>
        </div>
        <div className="box">
          <span>AVERAGE TEMP.</span>
          <span>{Api.data[6].temperature}</span>
        </div>
      </div>
    </div>
  );
