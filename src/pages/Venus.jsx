...
function Venus() {
  const [planetImg, setPlanetImg] = useState(Api.data[1].images.planet);
  const [paragraph, setParagraph] = useState(Api.data[1].overview);
  const [index, setIndex] = useState(0);
  function handleClick(i) {
    setIndex(i);
    if (i == 0) {
      setPlanetImg(Api.data[1].images.planet);
      setParagraph(Api.data[1].overview);
    } else if (i == 1) {
      setPlanetImg(Api.data[1].images.internal);
      setParagraph(Api.data[1].structure);
    } else if (i == 2) {
      setPlanetImg(Api.data[1].images.geology);
      setParagraph(Api.data[1].geology);
    }
  }
    ...
    <div className="container">
      ...
      <div className="footer">
        <div className="box">
          ...
          <span>{Api.data[1].rotation}</span>
        </div>
        <div className="box">
          <span>REVOLUTION TIME</span>
          <span>{Api.data[1].revolution}</span>
        </div>
        <div className="box">
          <span>radius</span>
          <span>{Api.data[1].radius}</span>
        </div>
        <div className="box">
          <span>AVERAGE TEMP.</span>
          <span>{Api.data[1].temperature}</span>
        </div>
      </div>
    </div>
  );
