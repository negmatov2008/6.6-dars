...
function Mars() {
  const [planetImg, setPlanetImg] = useState(Api.data[3].images.planet);
  const [paragraph, setParagraph] = useState(Api.data[3].overview);
  const [index, setIndex] = useState(0);
  function handleClick(i) {
    setIndex(i);
    if (i == 0) {
      setPlanetImg(Api.data[3].images.planet);
      setParagraph(Api.data[3].overview);
    } else if (i == 1) {
      setPlanetImg(Api.data[3].images.internal);
      setParagraph(Api.data[3].structure);
    } else if (i == 3) {
      setPlanetImg(Api.data[3].images.geology);
      setParagraph(Api.data[3].geology);
    }
  }
    ...
    <div className="container">
      ...
      <div className="footer">
        <div className="box">
          ...
          <span>{Api.data[3].rotation}</span>
        </div>
        <div className="box">
          <span>REVOLUTION TIME</span>
          <span>{Api.data[3].revolution}</span>
        </div>
        <div className="box">
          <span>radius</span>
          <span>{Api.data[3].radius}</span>
        </div>
        <div className="box">
          <span>AVERAGE TEMP.</span>
          <span>{Api.data[3].temperature}</span>
        </div>
      </div>
    </div>
  );
